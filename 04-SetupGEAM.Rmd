...
The GEAM questionnaire is hosted and managed by UOC, coordinator of the ACT project. The technical features of the LimeSurvey CE edition requires to centralize the management of accounts and creation of questionnaires. 
...
You can only launch the survey – and thus start to collect data – once you have signed and returned the corresponding “Declaration of Data Protection and Confidentiality” Statement provided in Annex 3 of this guide. 


## Adjusting global questionnaire settings
The GEAM Core as well as any other questionnaire requires adjusting of global settings. 
...
### Language(s)  
The GEAM Core questionnaire is available in different languages. Currently, the GEAM Core is available in English, Polish, Lithuanian, Spanish and German. Other languages are forthcoming.  
...
### Navigation 
LimeSurvey offers different options for presenting and navigating an active survey. Being an online environment, the navigation (and responses) can be organized by sub-sections or pages. For relatively short questionnaires, all questions can be presented in one-go, on a single page. For larger questionnaires, we recommend to organize user responses by sub-dividing the questionnaire in different thematic sections. The GEAM Core, given that it is a fairly long questionnaire, is sub-divided in 9 thematic sections where questions and response items for each section are presented on a single “page”.
...
The most important adjustments concern: 
...
2. Click botton "Edit default answer" 
...
3. Now selecte the desired organizational unit from the dropwdown menu and save your changes. Repeat this step for all active languages. 
...
After a new GEAM Core has been created, some content needs to be adapted. 
...
### Text messages
Adapting the GEAM Core questionnaire involves writing a specific welcome and ending message for the survey. It is an opportunity to introduce the questionnaire to your participants, explain its purpose, to whom it is addressed, why it is important to participate and what will happen to the results. 
