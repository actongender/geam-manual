...
**Validity** indicates that a given indicator actually measures the concept it is supposed to measure. For example, questions and corresponding answer options that measure work-life balance could target only the fit (or non-fit) of time-arrangements or be more specific and inquire about the degree with which work interferes with private life and vice versa. Validity implies a theoretical argument regarding how a certain social phenomena is conceived. Problematic are indicators that are supposed to measure social phenomena which rely upon a very fuzzy definition of the construct itself. What is meant by “job satisfaction” or “living standard” is not straight forward to answer. For the GEAM we have reviewed available measurement scales and their underlying constructs in @AldercotteACTGenderEquality2019.
...
Some basic ideas regarding correlation, causation and statistical inference are given in Analysis of Results (DRAFT) on page 46.
