...
- **Anonymized**. Concerns storage of meta-information with each survey entry. If turn "on", this overwrites the submission start and completion dates with a generic time 1980-01-91 in order to avoid potential matching of server log entries with survey submission.   
