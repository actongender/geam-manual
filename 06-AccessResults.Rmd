...
Initial explorations on the descriptive level should then be followed up with more in-depth statistical analysis. The ACT manual for statistical analysis of GEAM survey data is available for further guidance.
